// Phase 0 negative control: committed config without 'wasm-unsafe-eval'.
...
export default defineConfig({
  ...
  security: {
    csp: {
      ...
      scriptDirective: { resources: ["'self'"], hashes: ["sha256-D0X/RudTxbWCIEUFjAmwaX2l1yKdJadWf7FFW3+mpZE="] },
